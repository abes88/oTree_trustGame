...
class Player(BasePlayer):
    ...
    people_try_to_take_advantage_of_you_if_they_got_a_chance = models.CharField(
        max_length=100, choices=('Would take advantage of you', 'Would try to be fair'),
    ...
    most_of_the_time_people_try_to_be_helpful = models.CharField(
        max_length=100, choices=('Try to be helpful', 'Just look out for themselves'),
    ...
    that_most_people_can_be_trusted = models.CharField(
        max_length=100, choices=('Most people can be trusted', "Can't be too careful"),
